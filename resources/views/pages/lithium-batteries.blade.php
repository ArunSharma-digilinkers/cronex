...
<div class="page-banner-wrapper">
    <img src="{{ asset('img/lithium-banner.jpg') }}" alt="" class="img-fluid">
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="{{ asset('img/lithium-batteries.png') }}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                    <h2>Lithium Batteries</h2>
                    <p>
                        Cronex Inverter Lithium Batteries are designed to redefine backup power with superior efficiency, long life, and advanced technology. Unlike traditional lead-acid batteries, our lithium solutions deliver consistent power output, faster charging, and significantly longer backup time. Whether for homes, offices, shops, or critical appliances, Cronex ensures uninterrupted power with next-level reliability.
                    </p>
                    <p>
                      Built with high-performance LiFePO4 cells and an intelligent Battery Management System (BMS), Cronex inverter lithium batteries offer enhanced safety, thermal stability, and protection against overcharging, deep discharging, and short circuits. These batteries maintain excellent performance even in extreme temperatures, making them ideal for regions with frequent or prolonged power cuts.
                    </p>
                    <p>
                       Lightweight, compact, and maintenance-free, Cronex inverter lithium batteries are the perfect energy upgrade for modern power systems. Their long lifecycle, low electricity consumption, and eco-friendly design make them a smart investment for long-term energy savings. With Cronex, customers experience powerful backup, zero maintenance worries, and a durable energy solution built for the future.
                    </p>
                    <div class="about-btn">
