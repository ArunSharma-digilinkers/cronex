...
<div class="page-banner-wrapper">
    <img src="{{ asset('img/e-rickshaw-banner.jpg') }}" alt="" class="img-fluid">
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="{{ asset('img/e-rickshaw-batteries.png') }}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                    <h2>E-rickshaw Batteries</h2>
                    <p>
                        E-rickshaw batteries are designed to deliver long-lasting power, high mileage, and consistent performance for daily commercial use. Built with deep-cycle technology, they provide stable energy output even during long hours of operation. These batteries ensure smooth rides, reliable speed, and efficient power delivery—making them the perfect choice for e-rickshaw owners and fleet operators.
                    </p>
                    <p>
                        Our e-rickshaw batteries are engineered to handle frequent charging, heavy load conditions, and tough road environments. With enhanced durability, faster charging capability, and strong backup, they reduce downtime and increase earning potential for drivers. Their rugged design and low maintenance features ensure reliable performance throughout the battery life cycle.
                    </p>
                    <p>
                      Choosing our e-rickshaw batteries means investing in safety, power, and long-term value. Each battery is manufactured using high-grade materials, optimized plate technology, and advanced safety features to prevent overheating, leakage, and performance loss. Whether for individual riders or commercial fleets, our batteries deliver maximum efficiency and superior return on investment.
                    </p>
                    <div class="about-btn">
