    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <img src="{{ asset('img/solar-batteries-img.png') }}" alt="" class="img-fluid">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
                    <h2>Solar Batteries</h2>
                    <p>
                        Solar batteries are the backbone of an efficient solar power system, storing excess energy generated during the day for use at night or during power outages. Designed for high-performance energy retention, they ensure uninterrupted electricity supply and reduce dependence on the grid. With advanced deep-cycle technology, modern solar batteries deliver reliable, clean, and sustainable power for homes, businesses, and industrial applications.
                    </p>
                    <p>
                        Our solar batteries are engineered to withstand extreme weather conditions, frequent charge-discharge cycles, and long operational hours. They offer superior energy efficiency, faster charging capability, and minimal maintenance requirements—making them ideal for continuous renewable power usage. Whether it’s rooftop solar, off-grid systems, or hybrid setups, these batteries deliver maximum energy output consistently.
                    </p>
                    <p>
                       Choosing our solar batteries means investing in long-term performance, cost savings, and energy independence. Built with cutting-edge technology and quality materials, they improve the overall lifespan and efficiency of your solar system. From households to commercial installations, our batteries provide dependable power storage that supports a sustainable future while lowering electricity bills year after year.
                    </p>
                    <div class="about-btn">
